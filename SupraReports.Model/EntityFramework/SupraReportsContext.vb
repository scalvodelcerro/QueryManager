...
Public MustInherit Class SupraReportsContext
  ...
  Friend Class Naming
    ...
    Friend Const TABLA_PROGRAMACION As String = "NECA_PROGRAMACION"
  ...
  Protected Sub New(conn As DbConnection)
    ...
    Database.Log = AddressOf Console.Write
  End Sub
  ...
  Protected Overridable Sub ConfigurarEntity(entityEjecucion As EntityTypeConfiguration(Of Ejecucion))
    ...
    entityEjecucion.
        ...
        WillCascadeOnDelete()
    entityEjecucion.
        HasRequired(Function(x) x.UsuarioEjecucion).
        WithMany().
        HasForeignKey(Function(x) x.NombreUsuario).
        WillCascadeOnDelete()
    ...
    entityEjecucion.Property(Function(x) x.IdInforme).
        HasColumnName(Naming.CAMPO_ID_INFORME)
