...
Module ConnectionStrings
  ...
  'TODO FIXME - Concatenar ruta a keytab a  apartir de configuración de app
  'Public SUPRA_IMPALA_DES As String = "Driver=Cloudera ODBC Driver for Impala;Host=corporacionimpala.aacc.gs.corp;Port=21050;AuthMech=1;KrbRealm=IDMPRO.UNIX.AACC.CORP;KrbFQDN=corporacionimpala.aacc.gs.corp;KrbServiceName=impala;UseKeytab=1;UID=ueriskmi_sas@IDMPRO.UNIX.AACC.CORP;;DefaultKeytabFile=C:\DATOS\RIR\RIR_Aux.dll"
