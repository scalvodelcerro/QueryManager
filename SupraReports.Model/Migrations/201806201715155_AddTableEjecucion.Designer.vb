...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddTableEjecucion
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddTableEjecucion))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201806201715155_AddTableEjecucion"
            End Get
        End Property
